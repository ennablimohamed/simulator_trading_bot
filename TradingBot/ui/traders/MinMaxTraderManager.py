...
class MinMaxTraderTabManager:
    ...
    def __init__(self, app, trading_bot_data):
        ...
        self.app.callback(
            [
                Output({'type': 'min-max-trader-price-box', 'index': MATCH}, 'children'),
                Output({'type': 'min-max-trader-daily-profit', 'index': MATCH}, 'figure'),
                Output({'type': 'min-max-trader-buy-orders-table', 'index': MATCH}, 'data'),
                Output({'type': 'min-max-trader-trade-history-table', 'index': MATCH}, 'data'),
                Output({'type': 'min-max-trader-potential-profit-loss-box', 'index': MATCH}, 'children'),
                Output({'type': 'min-max-trader-script-runtime', 'index': MATCH}, 'children'),
                Output({'type': 'min-max-trader-capital-box', 'index': MATCH}, 'children'),
                Output({'type': 'min-max-trader-free-slots-box', 'index': MATCH}, 'children'),
                Output({'type': 'min-max-trader-total-profit-loss-box', 'index': MATCH}, 'children'),
                Output({'type': 'min-max-trader-min-price-box', 'index': MATCH}, 'children'),
                Output({'type': 'min-max-trader-mid-price-box', 'index': MATCH}, 'children'),
                Output({'type': 'min-max-trader-max-price-box', 'index': MATCH}, 'children'),

            ],
            [Input({'type': 'min-max-trader-interval-component', 'index': MATCH}, 'n_intervals')]
    ...
    def generate_trader_tab_content(self, trader_name, symbol):
        return html.Div([
            ...
            dbc.Row([
                dbc.Col([
                    dbc.Card([
                        ...
                        dbc.CardBody([
                            html.H4(
                                id={'type': 'min-max-trader-script-runtime', 'index': trader_name},
                ...
                dbc.Col([
                    dbc.Card([
                        ...
                        dbc.CardBody([
                            html.H4(id={'type': 'min-max-trader-capital-box', 'index': trader_name}, className='card-title',
                                    children="Loading..."),
                        ])
                ...
                dbc.Col([
                    dbc.Card([
                        ...
                        dbc.CardBody([
                            html.H4(id={'type': 'min-max-trader-free-slots-box', 'index': trader_name}, className='card-title',
                                    children="Loading..."),
                        ])
                ...
                dbc.Col([
                    dbc.Card([
                        ...
                        dbc.CardBody([
                            html.H4(id={'type': 'min-max-trader-potential-profit-loss-box', 'index': trader_name}, className='card-title',
                                    children="Loading..."),
                        ])
                    ], color="#4287f5", inverse=True)
                ], width=2),
                dbc.Col([
                    dbc.Card([
                        ...
                        dbc.CardBody([
                            html.H4(id={'type': 'min-max-trader-total-profit-loss-box', 'index': trader_name}, className='card-title',
                                    children="Loading..."),
                        ])
                    ], color="#4287f5", inverse=True)
                ], width=2)
            ...
            dbc.Row([
                dbc.Col([
                    dbc.Card([
                        ...
                        dbc.CardBody([
                            html.H4(id={'type': 'min-max-trader-min-price-box', 'index': trader_name}, className='card-title',
                                    children="Loading..."),
                        ])
                ...
                dbc.Col([
                    dbc.Card([
                        ...
                        dbc.CardBody([
                            html.H4(id={'type': 'min-max-trader-mid-price-box', 'index': trader_name}, className='card-title',
                                    children="Loading..."),
                        ])
                    ], color="blue", inverse=True)
                ], width=2),
                dbc.Col([
                    dbc.Card([
                        ...
                        dbc.CardBody([
                            html.H4(id={'type': 'min-max-trader-price-box', 'index': trader_name}, className='card-title',
                                    children="Loading..."),
                        ])
                    ], color="blue", inverse=True)
                ], width=2),
                dbc.Col([
                    dbc.Card([
                        ...
                        dbc.CardBody([
                            html.H4(id={'type': 'min-max-trader-max-price-box', 'index': trader_name}, className='card-title',
                                    children="Loading..."),
                        ])
                    ], color="blue", inverse=True)
                ], width=2)
            ...
            dbc.Row([
                dbc.Col([
                    dcc.Graph(id={'type': 'min-max-trader-daily-profit', 'index': trader_name})
                ], width=12)
            ]),
            html.Div([
                html.H4("Buy Orders"),
                dash_table.DataTable(
                    id={'type': 'min-max-trader-buy-orders-table', 'index': trader_name},
                    columns=[
                        {'name': '#', 'id': 'id'},
            ...
            html.Div([
                ...
                dash_table.DataTable(
                    id={'type': 'min-max-trader-trade-history-table', 'index': trader_name},
                    columns=[
                        {'name': '#', 'id': 'id'},
                        {'name': 'Opened at', 'id': 'opened_at'},
            ...
            dcc.Interval(id={'type': 'min-max-trader-interval-component', 'index': trader_name}, interval=1000, n_intervals=0)
        ])
