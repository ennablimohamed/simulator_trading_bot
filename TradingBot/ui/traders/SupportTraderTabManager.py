...
class SupportTraderTabManager:
    ...
    def __init__(self, app, trading_bot_data):
        ...
        self.app.callback(
            [
                Output({'type': 'support-box', 'index': MATCH}, 'children'),
                Output({'type': 'price-box', 'index': MATCH}, 'children'),
                Output({'type': 'resistance-box', 'index': MATCH}, 'children'),
                Output({'type': 'daily-profit', 'index': MATCH}, 'figure'),
                Output({'type': 'buy-orders-table', 'index': MATCH}, 'data'),
                Output({'type': 'trade-history-table', 'index': MATCH}, 'data'),
                Output({'type': 'potential-profit-loss-box', 'index': MATCH}, 'children'),
                Output({'type': 'script-runtime', 'index': MATCH}, 'children'),
                Output({'type': 'capital-box', 'index': MATCH}, 'children'),
                Output({'type': 'free-slots-box', 'index': MATCH}, 'children'),
                Output({'type': 'total-profit-loss-box', 'index': MATCH}, 'children'),
    ...
    def generate_trader_tab_content(self, trader_name, symbol):
        return html.Div([
            ...
            dbc.Row([
                dbc.Col([
                    dbc.Card([
                        ...
                        dbc.CardBody([
                            html.H4(
                                id={'type': 'script-runtime', 'index': trader_name},
                ...
                dbc.Col([
                    dbc.Card([
                        ...
                        dbc.CardBody([
                            html.H4(id={'type': 'capital-box', 'index': trader_name}, className='card-title',
                                    children="Loading..."),
                        ])
                ...
                dbc.Col([
                    dbc.Card([
                        ...
                        dbc.CardBody([
                            html.H4(id={'type': 'free-slots-box', 'index': trader_name}, className='card-title',
                                    children="Loading..."),
                        ])
                ...
                dbc.Col([
                    dbc.Card([
                        ...
                        dbc.CardBody([
                            html.H4(id={'type': 'potential-profit-loss-box', 'index': trader_name}, className='card-title',
                                    children="Loading..."),
                        ])
                    ], color="#4287f5", inverse=True)
                ], width=2),
                dbc.Col([
                    dbc.Card([
                        ...
                        dbc.CardBody([
                            html.H4(id={'type': 'total-profit-loss-box', 'index': trader_name}, className='card-title',
                                    children="Loading..."),
                        ])
                    ], color="#4287f5", inverse=True)
                ], width=2)
            ...
            dbc.Row([
                dbc.Col([
                    dbc.Card([
                        ...
                        dbc.CardBody([
                            html.H4(id={'type': 'support-box', 'index': trader_name}, className='card-title',
                                    children="Loading..."),
                        ])
                ...
                dbc.Col([
                    dbc.Card([
                        ...
                        dbc.CardBody([
                            html.H4(id={'type': 'price-box', 'index': trader_name}, className='card-title',
                                    children="Loading..."),
                        ])
                ...
                dbc.Col([
                    dbc.Card([
                        ...
                        dbc.CardBody([
                            html.H4(id={'type': 'resistance-box', 'index': trader_name}, className='card-title',
                                    children="Loading..."),
                        ])
            ...
            dbc.Row([
                dbc.Col([
                    dcc.Graph(id={'type': 'daily-profit', 'index': trader_name})
                ], width=12)
            ]),
            html.Div([
                html.H4("Buy Orders"),
                dash_table.DataTable(
                    id={'type': 'buy-orders-table', 'index': trader_name},
                    columns=[
                        {'name': '#', 'id': 'id'},
            ...
            html.Div([
                ...
                dash_table.DataTable(
                    id={'type': 'trade-history-table', 'index': trader_name},
                    columns=[
                        {'name': '#', 'id': 'id'},
                        {'name': 'Opened at', 'id': 'opened_at'},
            ...
            dcc.Interval(id={'type': 'interval-component', 'index': trader_name}, interval=1000, n_intervals=0)
        ])
